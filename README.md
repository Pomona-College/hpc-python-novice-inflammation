...
Python for research computing: arrays, visualisation, functions, conditionals and defensive programming. Adapted from Software Carpentry.

**Lesson site:** <https://pomona-college.github.io/hpc-python-novice-inflammation/>
...
Adapted from [swcarpentry/python-novice-inflammation](https://github.com/swcarpentry/python-novice-inflammation) by
...
The original lesson is maintained by the Software Carpentry community, with contributions from many authors — see `CITATION` for the full credit. Please cite the original lesson as set out in `CITATION`.
...
[swcarpentry/python-novice-inflammation](https://github.com/swcarpentry/python-novice-inflammation) so the wider community
benefits.
