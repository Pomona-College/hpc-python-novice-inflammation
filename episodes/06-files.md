...
::::::::::::::::::::::::::::::::::::: callout
## Batch Processing with Glob Scales Your Workflow

The `glob` pattern matching is how you scale from analyzing one file to hundreds or thousands. Once you have the loop working for one file, it works for all matching files. This is essential in research: your workflow should be able to grow with your data without rewriting code.
