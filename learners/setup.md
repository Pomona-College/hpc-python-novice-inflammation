...
2. Use **Clusters > Sagehen Shell Access** for a browser-based shell, or launch a **JupyterLab** session for an interactive Python notebook environment.
3. Load Python with `module load miniconda3`.
